...
_VALUE_PATTERNS = (
    ...
    re.compile(
        r"(?<![A-Za-z0-9])"
        r"(?:(?:\+82[ .-]?(?:2|3[1-3]|4[1-4]|5[1-5]|6[1-4]))|(?:\(0(?:2|3[1-3]|4[1-4]|5[1-5]|6[1-4])\)|0(?:2|3[1-3]|4[1-4]|5[1-5]|6[1-4])))"
        r"[ .-]\d{3,4}[ .-]\d{4}(?![A-Za-z0-9])"
    ),
    re.compile(r"(?<![A-Za-z0-9_-])(?:02\d{7,8}|0(?:3[1-3]|4[1-4]|5[1-5]|6[1-4])\d{7,8})(?![A-Za-z0-9_-])"),
    re.compile(r"(?<![A-Za-z0-9_-])\+82(?:2\d{7,8}|(?:3[1-3]|4[1-4]|5[1-5]|6[1-4])\d{7,8})(?![A-Za-z0-9_-])"),
