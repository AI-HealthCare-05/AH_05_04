"""Production HMAC query-fingerprint producer and binding verifier for #180 B2.

The composition root owns secret injection.  This module deliberately has no
environment/configuration access and no fallback or default key material.
"""
...
from ai_worker.tasks.rag.retrieval_run import sha256_canonical_json
...
def compute_query_binding_verifier_artifact_ref() -> ImmutableArtifactRef:
    ...
    return ImmutableArtifactRef(
        ...
        content_sha256=sha256_canonical_json(query_binding_verifier_policy_projection()),
    )
