...
- [Catalog DB 적재·저장 연결안](./proposed/post-mvp-1/catalog-db-integration-v2.md): #166 후속 Proposed. v2 내부 저장 준비·복원 코드와 D-02 인계 요청, D-03~D-06 구체 검토안. D-02 및 DB 인계 전 schema·migration·실제 적재는 미완료. 복원 후 현재 승인 포트 대조 포함; 실제 DB 연결은 미구현.
