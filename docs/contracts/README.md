...
- [Track B UNCONFIRMED backlog v1](./proposed/unconfirmed-backlog-v1.md): PD-418 URL·cursor·DTO·오류 제안. PR #426 브랜치의 v1 router 및 #413 PUT→GET HTTP 통합 구현. Cursor 404의 첫 페이지 재조회 명시, 변경 HEAD의 Backend/Frontend 승인 대기.
