...
- [Catalog DB 적재·저장 연결안](./proposed/post-mvp-1/catalog-db-integration-v2.md): #166 후속 Proposed. v2 내부 저장 준비·복원, 현재 승인 포트 대조와 D-02 비의존 Identity·Alias·Search Entry 스키마 기반을 구현. D-02 실행/Publication, Set/member·hash 저장과 실제 DB adapter transaction은 미완료.
