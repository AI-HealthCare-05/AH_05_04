...
- [Guide Medication Retrieval Query Authority v1 (#180 B2)](./targets/post-mvp-1/guide-medication-retrieval-query-authority-v1.md): verified medication의 pinned name/nullable strength snapshot을 one-medication query text로 exact projection하는 Target 계약. B1 carrier와 production fingerprint/query-binding verifier는 여전히 blocked다.
