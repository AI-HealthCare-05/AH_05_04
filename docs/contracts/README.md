...
- [#144 빈 검수 필드 생성 변경안](./proposed/ocr-empty-review-fields-144.md): 작업 브랜치 구조화·DB/API 검증 완료, DOC-03·리뷰 대기 — 기존 약품 행의 6개 검수 필드 보충, null·중복·PATCH 경계. 현재 OCR 계약에 통합할 변경분만 관리
