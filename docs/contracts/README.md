...
- [Guide Medication Guidance Retrieval Binding v1 (#180)](./targets/post-mvp-1/guide-medication-guidance-retrieval-binding-v1.md): Guide `retrieve_medication_guidance` production binding의 authoritative input 및 terminal replay blocker freeze. 구현·current runtime·READY 상태가 아님.
