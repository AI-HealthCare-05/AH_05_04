...
- [Catalog DB 적재·저장 연결안](./proposed/post-mvp-1/catalog-db-integration-v2.md): #166 후속 Proposed. v2 내부 저장 준비 코드와 D-03·D-04·D-06 제안. D-02 및 DB 인계 전 schema·migration·실제 적재는 미완료.
