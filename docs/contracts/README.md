...
- [Guide Runtime Release/Fallback Projection v1 (#180)](./targets/post-mvp-1/guide-runtime-release-v1.md): #890 authoritative outcome을 Safety Result v2 축과 기존 승인 fallback carrier로만 사영하는 순수 내부 kernel 계약. Backend public DTO·Evaluation Release Gate·Worker·LangGraph는 포함하지 않음
