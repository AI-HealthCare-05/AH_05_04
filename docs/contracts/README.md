...
- [Source Artifact·REJECTS 보존·삭제 정책 초안 (#335)](./proposed/post-mvp-1/source-artifact-retention-cleanup.md): 정책·담당 확정 대기, 공유 객체 참조 보호·cleanup 흐름·후속 검증 명세. 삭제 구현·활성화 승인 아님.
