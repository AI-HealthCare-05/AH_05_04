...
> 2026-09-15 후속: [PD-194](../../governance/decisions/2026-09-15-track-c-support-plan-api-194.md)의
> PM 결정에 따라 지원은 정렬의 첫 1개만 제안한다(후보 없음은 0개).
> 아래 최대 2개는 #192 작성 당시 목표 이력이다. 실제 조회·생성 DTO는
> [#194 부분 구현 계약](track-c-support-plan-api-194.md)을 따른다.
