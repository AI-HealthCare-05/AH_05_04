...
- [Answer Runtime Authority Binding Manifest 계약 v1 (#159)](./answer-runtime-binding-manifest-v1.md) — PR #833 책임 리뷰 승인 · Approved Target · Not implemented · 10 Canonical Recipes approved · 10 bindings implementation pending · 1 recipe unresolved (`RETRIEVED_EVIDENCE`) · 4 upstream authorities blocked; DEV manifest DTO/schema·recipe helpers·검증 착수 허용
