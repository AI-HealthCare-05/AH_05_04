...
- [Track B 일정 정합화 v1 (#417)](./track-b-schedule-reconciliation-v1.md): PR #424 승인 목표; DB #438·알림 #430·일정 API #456 병합. Current 승격은 구현·검증·책임 승인 증빙을 별도로 확인한다.
...
- [Answer Runtime Authority Binding Manifest 계약 v1 (#159)](./answer-runtime-binding-manifest-v1.md) — PR #833 책임 리뷰 승인 · Approved Target · Partially implemented · manifest DTO/schema, 10 canonical recipe helpers, self-hash/run/variant delta state validation, #808 typed seam projection·fail-closed tests 구현 완료 · 7개 supplemental authoritative runtime carrier/extractor, `RETRIEVED_EVIDENCE` authority/carrier, finalization 4 authorities, actual 3-variant pair execution 미구현
- [RAG Grounding·Citation Metric 계약 v1](./rag-grounding-citation-metrics-v1.md) — PR #541 책임 리뷰 승인 · Approved Target · Not implemented · 신규 observation/signal Schema Set version 승인 선행 필요
- [RAG Safety·Rule-first Metric 계약 v1](./rag-safety-rule-first-metrics-v1.md) — PR #541 책임 리뷰 승인 · Approved Target · Not implemented · #160 same-Case grounding signal을 소비하는 DEV kernel
...
- [Protected Retrieval Infrastructure 계약 v1](./protected-retrieval-infrastructure-v1.md) — data-plane 부분 구현, authorization control C1 구현 완료(PR #463), C2 command 및 최소 권한 확장 계약 확정 (`PD-368`, `PD-368-R1`, `PD-368-R2`), production approval source connector locator 및 commit authority binding 확정 (`PD-368-R3`)
