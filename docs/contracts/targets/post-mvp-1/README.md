...
- [Answer Runtime Authority Binding Manifest 계약 v1 (#159)](./answer-runtime-binding-manifest-v1.md) — PR #833 책임 리뷰 승인 · Approved Target · Not implemented · 10 Canonical Recipes + 1 Explicitly Unresolved Binding(`RETRIEVED_EVIDENCE`), 7 Supplemental runtime carrier 일부 unresolved 및 4 upstream finalization authorities blocked 유지; DEV manifest DTO/schema·recipe helpers·검증 착수 허용
