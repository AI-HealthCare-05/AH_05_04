...
세부 목표는 [비동기 Job 계약](./contracts/jobs/async-job-v1.md), [멱등성 계약](./contracts/jobs/idempotency-v1.md), [Outbox·Stream 계약](./contracts/jobs/outbox-stream-v1.md)을 따릅니다. 계약 파일의 존재는 구현 완료를 뜻하지 않습니다.
...
Track B·C·D 쓰기 API는 [멱등성 계약](./contracts/jobs/idempotency-v1.md)의 동기 snapshot 재현 규칙을 따릅니다. 세부 요청·응답, revision과 오류 의미는 [Check-in 계약](./contracts/medication/checkin-v1.md)과 [Safety Result 계약](./contracts/safety/safety-result-v1.md)을 기준으로 합니다.
