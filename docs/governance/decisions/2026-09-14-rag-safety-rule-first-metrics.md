# Product Decision: RAG Safety·Rule-first Metric 계약
...
| 연결 계약 | [`rag-safety-rule-first-metrics-v1.md`](../../contracts/targets/post-mvp-1/rag-safety-rule-first-metrics-v1.md) |
...
RAG-EVAL-006 DEV 구현을 위해 다음을 고정한다.
...
전이한다. 의료·약학 검토 evidence는 frozen Safety 실행 전 별도 필요하다.
