...
### Chat AI v6 대화 품질 Local 검증

실제 Provider 호출 없이 다음 결정론적 테스트로 최근 대화 조회와 현재 runtime의 단일 `chat-prompt-v6` 계약을 검증합니다.
...
- flag와 history 유무에 관계없는 `prompt_version == chat-prompt-v6`
