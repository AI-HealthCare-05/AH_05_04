...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("question_template", sa.String(length=255), nullable=True),
        sa.Column("source_segment", sa.String(length=255), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("non_sensitive_summary", sa.JSON(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.CheckConstraint(
            f"execution_status IN ({_sql_in_list(_EXECUTION_STATUS_VALUES)})",
    ...
    op.create_table(
        ...
        sa.Column("non_sensitive_context", sa.JSON(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
