"""Dedicated read-only retrieval composition for Guide CLOSED_DEMO.

This module consumes the sealed 17-product binding, runs the production retrieval kernel
under SET TRANSACTION READ ONLY, applies strict exact-product evidence filtering by
MFDS_ITEM_SEQ, and hydrates only authentic content for the Guide CLOSED_DEMO generator.
"""
