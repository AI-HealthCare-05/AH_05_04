...
Redis Stream·AI Worker 메시지 계약과 Worker 통합 테스트는 Post-MVP 범위이며 현재 구현되어 있지 않습니다. Backend 내부의 MySQL·채팅 동시성 통합 테스트는 `app/tests/chat_integration/`에 있으며 기본 `app` 테스트 범위에 포함됩니다.
