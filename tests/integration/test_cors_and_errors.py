...
API_ERROR_PATH = "/_test/api-error"
API_ERROR_HEADERS_PATH = "/_test/api-error-headers"
...
def register_test_routes() -> Iterator[None]:
    ...
    try:
        ...
        fastapi_app.router.routes[:] = [
            ...
            not in {UNEXPECTED_ERROR_PATH, HTTP_EXCEPTION_PATH, API_ERROR_PATH, API_ERROR_HEADERS_PATH}
        ]
