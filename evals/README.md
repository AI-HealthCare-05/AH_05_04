...
Schema Set `1.1.0`의 불변 참조는 `rag-eval.schema-set@1.1.0`, SHA-256 `ee60c207cd461d1a415d75d4b77e9976cb5055d4462893b51e1180a7ab2bb108`이다. 지정 책임 리뷰 승인 전에는 #214 Dataset Freeze의 승인 입력으로 사용하지 않는다.
