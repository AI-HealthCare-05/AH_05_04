...
Schema Set `1.3.0` 후보 참조는 `rag-eval.schema-set@1.3.0`, SHA-256 `e9843e190fbfabc6305d709e04ea296aefd107e66739882471fa3aedee08092f`이다. 상태는 `Candidate · Review Required`이며, 책임 리뷰어 권가빈 (`@hazelnutflavoured`)의 실제 Pull Request review event가 승인 전환에 필요하다. 기존 Schema Set과 exporter 기본 version은 변경하지 않는다.
